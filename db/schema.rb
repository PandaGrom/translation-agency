...
ActiveRecord::Schema.define(version: 20_211_207_151_107) do
  ...
  create_table 'files', force: :cascade do |t|
    ...
    t.index ['order_id'], name: 'index_files_on_order_id'
  end
  ...
  add_foreign_key 'files', 'categories'
  add_foreign_key 'files', 'orders'
  add_foreign_key 'orders', 'categories'
  add_foreign_key 'orders', 'users'
  add_foreign_key 'reports', 'files'
